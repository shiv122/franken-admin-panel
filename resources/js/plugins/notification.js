        ...
        628: (t, e, n) => {
            ...
            var a = {
                ...
                icons: {
                    ...
                    alert: "icon='circle-alert' ",
                    async: "icon='loader-pinwheel' class='spin'",
                    confirm: "icon='circle-alert'",
                    prefix: "<uk-icon stroke-width='3' height='24' width='24' ",
                    suffix: "></uk-icon>",
                    enabled: !0
                },
                replacements: {
                ...
                f = {
                    ...
                    klass: {
                        ...
                        dotAnimation: "".concat(u.popup, " flex justify-center")
                    },
                    ids: {
                    ...
                    value: function (t) {
                        ...
                        switch (this.type) {
                            case "confirm":
                                ...
                                break;
                            case "async-block":
                                e = "".concat(e, '<uk-icon class="spin ').concat(f.klass.dotAnimation, '" icon="loader-pinwheel" ></uk-icon>')
                        }
